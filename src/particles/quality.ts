...
const DESKTOP: Record<QualityLevel, Omit<Tier, "pixelRatio">> = {
  high: { level: "high", instances: 10000, post: "full" },
  medium: { level: "medium", instances: 7500, post: "bloom" },
  low: { level: "low", instances: 4000, post: "minimal" },
};

const MOBILE: Record<QualityLevel, Omit<Tier, "pixelRatio">> = {
  high: { level: "high", instances: 7000, post: "bloom" },
  medium: { level: "medium", instances: 5000, post: "bloom" },
  low: { level: "low", instances: 3000, post: "minimal" },
};
